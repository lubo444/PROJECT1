...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'test_company.web_model' => 'getTestCompany_WebModelService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Test\\Bundle\\CompanyBundle\\Resources\\config\\doctrine') => 'Test\\Bundle\\CompanyBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Test\\Bundle\\CompanyBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('TestCompanyBundle' => 'Test\\Bundle\\CompanyBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_64d1c74df1347171bf426e8b300fa6184fb845587ad5f139308cc210156ef89b');
    ...
    /**
     * Gets the 'test_company.web_model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Test\Bundle\CompanyBundle\Model\WebModel A Test\Bundle\CompanyBundle\Model\WebModel instance
     */
    protected function getTestCompany_WebModelService()
    {
        return $this->services['test_company.web_model'] = new \Test\Bundle\CompanyBundle\Model\WebModel();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Test\\Bundle\\CompanyBundle/Resources/views'), 'TestCompany');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('46028e0ba4ab0d5b0080e3eef7c35d2bf90c2439');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('577a099782ca03.93203899')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TestCompanyBundle' => 'Test\\Bundle\\CompanyBundle\\TestCompanyBundle',
            ...
            'secret' => '46028e0ba4ab0d5b0080e3eef7c35d2bf90c2439',
            'locale' => 'en',
            ...
            'kernel.secret' => '46028e0ba4ab0d5b0080e3eef7c35d2bf90c2439',
